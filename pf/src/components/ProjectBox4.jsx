...
const ProjectBox4 = ({ project }) => {
  return (
    <SkillWrap>
      <ItemWrap>
        <ProjectItem height="50rem">
          <ProjectTitle>영남대학교병원 중간금 수납</ProjectTitle>
          ...
          <ProjectContentWrap>
            ...
            <ProjectContentExplanWrap>
              <MainDescription>
                ...
                <br />
                <br />
                UI/UX부터 직접 디자인하여 순수 HTML 및 CSS와 PHP를 통해
                프로젝트를 개발했습니다. 그뿐만 아니라 PG 결제 연동과 병원 내
                데이터를 연동하여 좋은 경험이 되었던 프로젝트입니다.
              </MainDescription>
              <SubDescriptionBox>
                <SubDescriptionLabel>기능</SubDescriptionLabel>
                <SubDescriptionValue>
                  로그인, 환자 정보 확인, 중간금 정보 확인, 중간금 결제, 중간금
                  부분 결제
                </SubDescriptionValue>
              </SubDescriptionBox>
              <SubDescriptionBox>
